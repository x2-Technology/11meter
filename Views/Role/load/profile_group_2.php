...
<?/* $k = "visibility"; */?><!--
<li class="cell switch  ">
    <label for="xs" class="">Ich bin offen für Angebote</label>
    <div class="switch">
...
if( !count($this->data->user_used_role_id ) ){ ?>
    ...
    <li class="cell border-bottom" >
        <input type="button" value="VEREIN EINFÜGEN" data-data="<?= Helper::JSONCleaned($this->data->viewControllerForRoleAssistantData); ?>">
    </li>
...
<div class="p-0 relative w-100 float-left mt-20">
    <ul class="x2-list" id="role_club" >
        ...
        <?php /*echo $this->data->user_clubs_for_role; */?>
    </ul>
</div>
