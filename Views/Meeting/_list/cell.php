...
<!--<li data-id="<?/*= $this->data["db"]["id"]; */?>" class="row-h-130 cell nopadding h-100 pos-relative" >-->
<li data-id="<?= $this->data["db"]["id"]; ?>" class="cell p-0 pr-10" >


    <!--INFO BUTTON ON TOP-->
    <a data-data="<?= $data; ?>" class="action">
        <table class="w-100 row-h-130 nopadding nomargin" style="top:0; left:0">
                            ...
                            <td class="align-top nomargin nopadding">
                                <div class="w-100 h-100 pl-10">
                                    <div class="w-70 float-left h-100">
                                        ...
                                        <table class="font-mini mt-5 meeting-deep-info">

                                            <!--Start Road-->
                                                <?php if (!is_null($this->data["db"]["abfahrt_ort"])) { ?>
                                                    <tr>
                                                        <td class="font-bold pt-1 pb-0 pl-0">
                                                            <i class="icon icon-bus mr-2"></i>
                                                        </td>
                                                        <td class="font-bold pt-1 pb-0 pl-0 font-normal">
                                            ...
                                            <tr >
                                                ...
                                                <td class="font-bold pt-1 pb-0 pl-0">
                                                        <div class="pos-absolute w-100 pt-1 text-ellipsis" style="top: 0;">
                                                                <?= $this->data["db"]["ort"]; ?>
                                                        </div>
                                                </td>
                                        ...
                                        <div class="d-sm-table-row">
                                            ...
                                            <div class="pos-absolute" style="right: 0;">
                                                    ...
                                                    <?php if ($this->data["db"]["is_active"]) { ?>
                                                            ...
                                                            <?php if (!true) { ?>
                                                            <span class="mr-2 p-2 float-left text-center" style="width: <?= $cageD; ?>; height: <?= $cageD; ?>; <?= $border; ?>"><i class="icon icon-warning text-warning icon-size-table-cell-big" ></i></span>
                                                            <?php } ?>

                                                        <!--UNIFORM-->
                                                            <?php if ($this->data["post"]["isMatch"]) { ?>
                                                            <span class="mr-2 p-2 float-left text-center" style="width: <?= $cageD; ?>; height: <?= $cageD; ?>; <?= $border; ?>"><i class="icon icon-uniform text-disabled icon-size-table-cell-big" ></i></span>
                                                            <?php } ?>
                                                        ...
                                                        <span class="mr-2 p-2 float-left text-center icon-size-table-cell-big" id="my-availability" style="<?= $cageD; ?>; height: <?= $cageD; ?>; <?= $border; ?>">
                                                    ...
                                                    <?php } else {  ?>
                                                            ...
                                                            <span class="mr-2 p-2 float-left text-center"
                                                                  style="width: <?= $cageD; ?>; height: <?= $cageD; ?>; <?= $border; ?>"><img
                                                                        src="<?= $club_logo; ?>"
                                                                        style="width: <?= $cageD; ?>; height: <?= $cageD; ?>;"></span>
                                                            <span class="mr-2 p-2 float-left text-center font-italic"
                                                                  style="width: <?= $cageD; ?>; height: <?= $cageD; ?>; <?= $border; ?>">vs</span>
                                                            <span class="mr-2 p-2 float-left text-center"
                                                                  style="width: <?= $cageD; ?>; height: <?= $cageD; ?>; <?= $border; ?>"><img
                                                                        src="<?= $opponent_logo; ?>"
                                                                        style="width: <?= $cageD; ?>; height: <?= $cageD; ?>;"></span>
