    ...
    * */
    ...
    this.TableView = function (Element, pars) {
        ...
        this.parameters = Object.assign({
            ...
            action: ["Title", function ( El, row, _class ) {}],
        ...
        this.init = function () {
            ...
            if (undefined !== TableView) {
                    ...
                    TableView.querySelector("li.x2-table-search") === null )
                {
                    ...
                    searchButton.innerText = "Searchs";
                    
                    searchButton.ontouchstart = function () {
                        alert(4);
        ...
        * */
        ...
        this.prepareTableRow = function (row) {
            ...
            let deleteElWrapper     = document.createElement("div");
            deleteElWrapper.classList.add("content-action");
    
            // Delete Button
            let deleteEl            = document.createElement("button");
            deleteEl.innerText      = _class.parameters.action[0];
            deleteEl.ontouchend     = function(e){
                try{
    
                    _class.parameters.action[1]( this, row, _class );
                    
                    rowBodyWrapper.classList.remove("to-open");
                    rowBodyWrapper.classList.add("to-close");
                    setTimeout(function () {
                        rowBodyWrapper.style.left = 0;
                    },300);
            ...
            deleteElWrapper.append(deleteEl);
            
            // Body Wrapper
            rowBodyWrapper      = document.createElement("div");
            rowBodyWrapper.classList.add("body-wrapper");
    
            // Body Content
            rowBodyContent          = document.createElement("div");
            rowBodyContent.setAttribute("class", row.getAttribute("class"));
            rowBodyContent.classList.add("content-body");
            rowBodyContent.classList.remove("cell");
            
            
            rowBodyContent.innerHTML       = row.innerHTML;
    
            rowBodyWrapper.appendChild(rowBodyContent);
    
            rowContent.appendChild(deleteElWrapper);
            rowContent.appendChild(rowBodyWrapper);
    
    
            // @Overwrite [while the original li row element replaced]
            rowElements = rowBodyContent.children;
            ...
            // rowEvents(rowBodyWrapper);
            
            /*function rowEvents(El){
                ...
                El.onmousedown = function(e){
                    ...
                    document.getElementById("start-pos").innerText = startPos;
        
                    /!*
                    
                    *!/
                    /!*
                    if( El.querySelector(".row-body").classList.contains("to-open") ){
                        startPos = El.querySelector(".row-body").offsetLeft + e.clientX ;
                }
                *!/
                ...
                El.onmouseup = function(e){
                    ...
                    document.getElementById("end-pos").innerText = currentPos;
                    let res = currentPos - startPos;
        
                    if( res < -40 ){
            
                        El.querySelector(".row-body").classList.add("to-open");
                        El.querySelector(".row-body").classList.remove("to-close");
            
                    }
        
                    else {
            
                        El.querySelector(".row-body").classList.remove("to-open");
                        El.querySelector(".row-body").classList.add("to-close");
            
                        setTimeout(function(){
                            El.querySelector(".row-body").style.left = -1 + "px";
                        },300);
                ...
                El.onmousemove = function(e){
                    ...
                    if( e.buttons || e.which ){
                        ...
                        document.getElementById("move-pos").innerText = currentPos;
            
                        if(
                            El.querySelector(".row-body").classList.contains("to-close") ||
                            El.querySelector(".row-body").classList.contains("to-open")
                        ){
                            El.querySelector(".row-body").classList.remove("to-close");
                            El.querySelector(".row-body").classList.remove("to-open");
                        }
                        ...
                        El.querySelector(".row-body").style.left = res + "px";
            ...
            if (rowBodyContent.querySelector("a") !== null || rowBodyContent.querySelector("button") !== null) {
                ...
                console.log("rowBodyWrapper children", rowBodyWrapper.children);
                ...
                if( !X2.fromDevice() ){
                    ...
                    if( row.ontouchend === null ){
    
                        
                        rowBodyWrapper.ontouchend = function (e) {
                            
                            let touchActionStop = false;
                            ...
                            try{
                                ...
                                if( parseInt(rowBodyWrapper.style.left) < 0 ){
    
                                    if(rowBodyWrapper.classList.contains("to-open")){
                                        touchActionStop = true;
                                    }
                                    ...
                                    if( res < -40 ){
                                        ...
                                        rowBodyWrapper.classList.add("to-open");
                                        rowBodyWrapper.classList.remove("to-close");
    
                                        setTimeout(function(){
                                            rowBodyWrapper.style.left = -80 + "px";
                                        },300);
                            ...
                            if( touchActionStop ) return false;
                            ...
                            if (moveEvent  ) {
                                ...
                                if (null !== prevTouchEndEvent) {
                                    ...
                                    // alert("TouchEnd Effect:" + this.dataset.data);
                                    if ( actionElement.dataset !== undefined && actionElement.dataset.data !== undefined) {
                                        setTimeout(function () {
                                            
                                            X2.presentViewControllerWithData( actionElement.dataset.data );
                    ...
                    if( row.ontouchmove === null ){
        
                        row.ontouchmove = function (e) {
                            moveEvent = true;
    
                            // rowBodyContent.innerHTML = "Selam";
                            
                            /// TODO FOR Row Delete
                            // if( ( e.buttons || e.which ) ){
                            // rowBodyWrapper.innerText = e.movementX;
                                // alert(3);
                            // rowBodyWrapper.classList.add("to-open");
                                try{
                                    ...
                                    if(
                                        rowBodyWrapper.classList.contains("to-close") ||
                                        rowBodyWrapper.classList.contains("to-open")
                                    ){
                                        rowBodyWrapper.classList.remove("to-close");
                                        rowBodyWrapper.classList.remove("to-open");
                                    }
                                    ...
                                    // rowBodyContent.innerHTML = parseInt(e.changedTouches[0].pageX);
                                    if( res > -80 && res < 0 ){
                                        rowBodyWrapper.style.left = res + "px";
                                        e.preventDefault();
                                    }
                ...
                if (row.classList.contains("disabled")) {
                    ...
                    /*if (null !== rowBodyContent.querySelector("a")) {
                        rowBodyContent.querySelector("a").classList.add("disabled");
                    }
                    
                    if (null !== rowBodyContent.querySelector("button")) {
                        rowBodyContent.querySelector("button").classList.add("disabled");
                    }*/
            ...
            // OTHER ELEMENTS
                ...
                * */
                if (hasRadio || hasCheck) {
                    ...
                    // Find Switch
                    for (let d = 0; d < rowBodyContent.children.length; d++) {
                        
                        let _switch = undefined;
                        console.log("Switch Elements", rowBodyContent.children[d].classList);
                        if (rowBodyContent.children[d].classList.contains("switch")) {
                            _switch = rowBodyContent.children[d];
                        }
                        
                        if (undefined !== _switch) {
                            
                            // Wrap the SwitchElement
                            // START
                            let switchWrapper = document.createElement("div");
                            switchWrapper.style.display         = "table-cell";
                            switchWrapper.style.verticalAlign   = "middle";
                            rowBodyContent.append(switchWrapper);
                            
                            switchWrapper.innerHTML = _switch.outerHTML;
                            _switch.remove();
                            console.log("Found Switch Element", switchWrapper);
                           
                            
                            
                            let _switchElements = switchWrapper.children[0].children;
